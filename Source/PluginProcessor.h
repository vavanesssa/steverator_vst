...
public:
    ...
    //==============================================================================
    // 1. Preparation
    // Called before playback starts. Use this to initialize DSP with the sample rate.
    ...
    // Used to save the state (parameters) when the user saves a project in the DAW.
